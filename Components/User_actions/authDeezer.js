...
class ModifUser extends React.Component {
    ...
    _onNavigationStateChange(webViewState) {
        ...
        if (my_url.includes('https://us-central1-music-room-42.cloudfunctions.net/callbackDeezer') &&  !my_url.includes('https://connect.deezer.com/oauth/auth.php?app_id=332122&redirect_uri=')) {
